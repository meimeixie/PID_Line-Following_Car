...
void LCD_ShowIntNum(u16 x,u16 y,u32 num,u8 len,u8 size,u16 color);  						//显示一个数字
void LCD_ShowxNum(u16 x,u16 y,u32 num,u8 len,u8 size,u8 mode,u16 color);				//显示 数字
void LCD_ShowString(u16 x,u16 y,u16 width,u16 height,u8 size,char *p,u16 color);		//显示一个字符串,12/16字体
void LCD_ShowFloatNum(u16 x,u16 y,float num,u8 lenINT,u8 lenDEC,u8 size,u16 color);//显示一个小数
